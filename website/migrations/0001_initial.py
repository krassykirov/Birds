# Generated by Django 3.1.12 on 2021-09-21 07:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('bird_name', models.CharField(max_length=100, unique=True, validators=[django.core.validators.RegexValidator(message='Name should contain only alphabets not numbers or other special characters', regex='[a-zA-ZЀ-ӿ]$')])),
